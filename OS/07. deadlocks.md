...
네모는 리소스, 점 개수는 리소스의 개수-instance의 개수
...
ppt의 오른쪽 그림은 cycle이 형성되어있지만 deadlock 상태가 아니다. P2가 언젠가 끝나게 되어 instance 1개가 free 되면 P1은 R1을 점유할 수 있고 P3는 R1의 두번째 resource를 가져다 쓰는 것은 deadlock이 아님.
